...
<!-- #include virtual="en/incl/global/auth_check.asp"-->
    ...
    <head>
        ...
        <title>HCP Page</title>
        <meta name="description" content="HCP Page for Apo-Semaglutide">
                ...
                <div class="row justify-content-center items-wrapper col-lg-10">
                        ...
                        <div class="item-wrapper large-radius">
                            <div class="card-box card-wrap">
                                <h3 class="card-title mbr-fonts-style display-5">
                                    Getting Started with Apo-Semaglutide
                                </h3>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 item features-without-image">
                        <div class="item-wrapper large-radius">
                            <div class="card-box card-wrap">
                                <h3 class="card-title mbr-fonts-style display-5">
                                    How to use your Apo-Semaglutide pen?
                                </h3>
                                <p class="card-text mbr-fonts-style display-7">
                                    Watch this step-by-step instruction video.
                                </p>
                                <div class="mbr-section-btn">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 item features-without-image">
                        <div class="item-wrapper large-radius">
                            <div class="card-box card-wrap">
                                <h3 class="card-title mbr-fonts-style display-5">
                                    Apo-Semaglutide Product Monograph
                                </h3>
                                <p class="card-text mbr-fonts-style display-7">
                                    Download the Product Monograph for more information.
                                </p>
                                <div class="mbr-section-btn">
                                    <a href="#" class="btn btn-outline display-7">Product Monograph</a>
                                </div>
                            </div>
                        </div>
                    </div>
